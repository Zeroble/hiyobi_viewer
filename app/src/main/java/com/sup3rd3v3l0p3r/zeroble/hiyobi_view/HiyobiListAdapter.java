...
public class HiyobiListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 아이템 내 각 위젯에 데이터 반영
        iconImageView.setImageDrawable(hiyobiListItem.getIconDrawable());
    ...
    public void addItem(Drawable icon, String title, String artist,String original,String type,String tags,String url) {
